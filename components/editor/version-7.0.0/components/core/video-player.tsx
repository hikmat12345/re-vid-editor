        ...
        <div className="z-10 absolute inset-2 sm:inset-4 flex items-center justify-center">
          ...
          >
            <Player
              ...
              component={Main}
              compositionWidth={Math.round(compositionWidth)}
              compositionHeight={Math.round(compositionHeight)}
              style={{
                width: "100%",
                height: "100%",
              }}
              durationInFrames={Number(Math.round(PLAYER_CONFIG.durationInFrames))}
              ...
              inputProps={{
                ...
                changeOverlay,
                selectedOverlayId,
                durationInFrames: Number(Math.round(durationInFrames)),
                fps: FPS,
